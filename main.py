...
EDA + FastAPI + JWT + PostgreSQL.

### TP2

CRUD + modelos + schemas + integração com banco de dados.

### TP3

Segurança, autorização, auditoria e proteção dos endpoints.

### TP4

Integração de Inteligência Artificial para análise dos chamados.

### TP5

Agente de IA, monitoramento e mecanismos inteligentes de segurança.
